...
local borderSize, iconSize, flashSize = scale(464,512), scale(64,42), scale(64,54)
...
local borderTexture = path("masque-border-arcanestone1")

MSQ:AddSkin("Arcane Stone", {
	Shape = "Circle",
	...
	Websites = {
		"https://github.com/AzeriteTeam/Masque_ArcaneStone",
		"https://www.curseforge.com/wow/addons/masque-arcanestone"
	},
