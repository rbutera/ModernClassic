...
if GetLocale() ~= "zhCN" then
    ...
    Spell({ 980, 1014, 6217, 11711, 11712, 11713, 22959}, { 
        duration = function(spellID)
...
Spell({ 980, 1014, 6217, 11711, 11712, 11713, 22950}, { duration = 24, stacking = true }) -- Curse of Agony
...
if GetLocale() ~= "zhCN" then
    Spell(22959, { duration = 30 }) -- Fire Vulnerability 灼烧debuff 痛苦诅咒
end
