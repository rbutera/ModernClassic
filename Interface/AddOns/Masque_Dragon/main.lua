...
local borderTexture = path("masque-border-dragon1")

MSQ:AddSkin("Dragon", {
	Shape = "Circle",
	Masque_Version = 80100,

	Description = "A dragon themed metal texture.",
	Version = GetAddOnMetadata(ADDON, "Version"),
	Authors = { "Daniel Troko", "|cff999999Lars Norberg|r" },
	Websites = {
		"https://github.com/AzeriteTeam/Masque_Dragon",
		"https://www.curseforge.com/wow/addons/masque-dragon"
	},
