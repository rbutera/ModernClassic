...
function ProgressBar:New(parent,name,style)
	local ProgressBar = CHAIN(CreateFrame("Button", name, parent))
	...
	ProgressBar.Texture = CHAIN(ProgressBar.ClipFrame:CreateTexture())
		:SetWidth(1)
		:SetPoint("LEFT")
		:SetPoint("TOP")
		:SetPoint("BOTTOM")
	...
	ProgressBar.Decor = CHAIN(ProgressBar.ClipFrame:CreateTexture())
		:SetWidth(1)
		:SetPoint("TOP")
		:SetPoint("BOTTOM")
