...
local borderSize, iconSize, flashSize = scale(448,512), scale(64,42), scale(64,54)
...
local backdropTexture = path("masque-backdrop-arakkoa1")
local borderTexture = path("masque-border-spikystone1")

MSQ:AddSkin("Spiky Stone", {
	Shape = "Circle",
	Masque_Version = 80100,

	Description = "A spiky circular stone texture.",
	Version = GetAddOnMetadata(ADDON, "Version"),
	Authors = { "Daniel Troko", "|cff999999Lars Norberg|r" },
	Websites = {
		"https://github.com/AzeriteTeam/Masque_SpikyStone",
		"https://www.curseforge.com/wow/addons/masque-spikystone"
	},
