...
local function Defense()
	...
	local TooltipLine1 = "Base Defense including talents such as Warrior's Anticipation is "..baseDefense.."."
	local TooltipLine2 = "Bonus Defense from items and enhancements is "..armorDefense.."."
	local TooltipLine3 = "Total Defense is "..(baseDefense + armorDefense)..". Critical Hit immunity for a level 60 player against a raid boss occurs at 440 Defense and requires a defense skill of 140 from items and enhancements to achieve."
